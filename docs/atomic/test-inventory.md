...
| --- | --- | --- |
| C++ Atomic rules/state | Atomic SEE, explosion deltas, terminal captures, en passant, promotions, castling/Atomic960, repetition, rule 50, UCI moves | `30/30` PASS lines and terminal success marker |
| Shared C++ board API | SAN, outcomes, checked pieces, material, FEN validation and Atomic960 | `29/29` PASS lines and terminal success marker |
| Historical Python API | Frozen Fairy `test.py` contracts | `22/22`; two removed-variant APIs are classified, not skipped |
| Extended Python API | Fixtures, perft, errors, transactional calls and concurrent independent calls | `pytest`: `54 passed` |
