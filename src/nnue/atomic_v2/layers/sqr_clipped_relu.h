...
#ifndef ATOMIC_V2_LAYERS_SQR_CLIPPED_RELU_H_INCLUDED
#define ATOMIC_V2_LAYERS_SQR_CLIPPED_RELU_H_INCLUDED
...
#endif  // ATOMIC_V2_LAYERS_SQR_CLIPPED_RELU_H_INCLUDED
