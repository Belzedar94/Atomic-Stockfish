...
EXPERIMENT_ID = "atomic-e00-src-v3-launch7-20260725"
SMOKE_BATTERY_ID = "atomic-e00-src-v3-launch7-smoke"
FULL_BATTERY_ID = "atomic-e00-src-v3-launch7-full"
...
def _fixture(tmp_path: Path) -> dict[str, Any]:
    ...
    design = tmp_path / "e00-src-v3-launch7-design"
    smoke_root = tmp_path / "e00-src-v3-launch7-smoke"
    full_root = tmp_path / "e00-src-v3-launch7-full"
    capture_root = tmp_path / "e00-src-v3-launch7-captures"
    smoke_root.mkdir()
    capture_root.mkdir()
    ...
    full_schedule, full_schedule_receipt = _publish_schedule(
        ...
        pairs=84,
        games=168,
        seed="atomic-e00-src-full-v3-launch7-20260725",
    )
    smoke_schedule, smoke_schedule_receipt = _publish_schedule(
        design / "smoke-schedule",
        pairs=1,
        games=2,
        seed="atomic-e00-src-smoke-v3-launch7-20260725",
    )
