...
- [`docs/atomic/e00-launch5-prepare-smoke-runbook.md`](docs/atomic/e00-launch5-prepare-smoke-runbook.md);
- [`docs/atomic/e00-launch5-full-runbook.md`](docs/atomic/e00-launch5-full-runbook.md).
