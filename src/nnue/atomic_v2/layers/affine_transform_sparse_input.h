...
#ifndef ATOMIC_V2_LAYERS_AFFINE_TRANSFORM_SPARSE_INPUT_H_INCLUDED
#define ATOMIC_V2_LAYERS_AFFINE_TRANSFORM_SPARSE_INPUT_H_INCLUDED
...
namespace Stockfish::Eval::NNUE::AtomicV2::Layers {
...
class AffineTransformSparseInput {
   public:
    ...
    #undef RVV_SPARSE_PROPAGATE
        ...
        ::Stockfish::Eval::NNUE::Layers::affine_transform_non_ssse3<
          InputDimensions, PaddedInputDimensions, OutputDimensions>(output, weights, biases, input);
#endif
    }
...
#endif  // #ifndef ATOMIC_V2_LAYERS_AFFINE_TRANSFORM_SPARSE_INPUT_H_INCLUDED
